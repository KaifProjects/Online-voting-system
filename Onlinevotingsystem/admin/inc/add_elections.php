...
if(isset($_POST['updateElectionBtn'])) {
    ...
    mysqli_query($db, "UPDATE elections SET election_topic = '$election_topic', no_of_candidates = '$number_of_candidates', starting_date = '$starting_date', ending_date = '$ending_date' WHERE id = '$edit_id'");
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <button type="button" class="btn btn-sm btn-warning" data-toggle="modal" data-target="#editModal<?php echo $election_id; ?>">Edit</button>
                            <button class="btn btn-sm btn-danger" onclick="DeleteData(<?php echo $election_id; ?>)">Delete</button>
                        </td>
                    </tr>

                    <!-- Edit Modal -->
                    <div class="modal fade" id="editModal<?php echo $election_id; ?>" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
                            ...
                            <div class="modal-content">
                                ...
                                <form method="POST">
                                    <div class="modal-body">
                                        <div class="form-group">
                                            <input type="text" name="election_topic" placeholder="Election Topic" class="form-control" value="<?php echo $row['election_topic']; ?>" required />
                                        </div>
                                        <div class="form-group">
                                            <input type="number" name="number_of_candidates" placeholder="No of Candidates" class="form-control" value="<?php echo $row['no_of_candidates']; ?>" required />
                                        </div>
                                        <div class="form-group">
                                            <input type="text" onfocus="this.type='Date'" name="starting_date" placeholder="Starting Date" class="form-control" value="<?php echo $row['starting_date']; ?>" required />
                                        </div>
                                        <div class="form-group">
                                            <input type="text" onfocus="this.type='Date'" name="ending_date" placeholder="Ending Date" class="form-control" value="<?php echo $row['ending_date']; ?>" required />
                                        </div>
                                    </div>
                                    <div class="modal-footer">
                                        <input type="hidden" name="edit_id" value="<?php echo $election_id; ?>">
